    ...
    <div className='flex flex-col items-center'>
      <div className='pt-10 w-full lg:w-[60%]'>
              ...
              <div className='flex items-center gap-5'>
                ...
                <div>
                  ...
                  <div>
                    ...
                    <CopyIcon size={12} className='cursor-pointer  hover:text-white-200'/>
        ...
        <div className='py-5 pt-10'>
         ...
         {wallet.transactions.map((item,i)=> <div key={i} className='space-y-5'>
             <div>
            ...
            <div className='flex items-center gap-5'>
              ...
              <div className='space-y-1'>
                <h1 className="text-base mb-3">{item.type || item.purpose}</h1>
