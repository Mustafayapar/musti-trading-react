...
function Home() {
    ...
    return (
        <div className='relative'>
                    ...
                    <div className='flex gap-5 items-center'>
                        ...
                        <div>
                            ...
                            <div className="flex items-end gap-2">
                                <p className="text-x1 font-bold">45454</p>
                                <p className='text-red-600'>
                                    <span>+6454545.45</span>
                                    <span>(0.2124%)</span>
                                </p>
                            </div>
                        </div>
            ...
            <section className='fixed bottom-5 right-5 z-40 flex flex-col
        justify-end items-end gap-2' >
            ...
            bg-slate-900 '>
                ...
                py-2 scroll-container'>
                    ...
                    bg-slate-800 w-auto'>
                                <p>hi, Sir</p>
                                <p> you can ask questions sir...</p>
                                <p>everything like price, marketcap... </p>
                            </div>
